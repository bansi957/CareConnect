...
const Field = ({ label, name, type = "text", placeholder, required = true, minLength, value, onChange }) => (
    <div>
            ...
            <div className="max-w-5xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
                ...
                <div className="md:w-5/12 bg-blue-600 p-8 flex flex-col justify-between text-white relative overflow-hidden">
                    <div className="relative z-10">
                        <h1 className="text-4xl font-extrabold tracking-tight mb-2">CareConnect</h1>
                    ...
                    <div className="relative z-10 mt-8">
                        ...
                        <ul className="space-y-3 text-blue-100 text-sm">
                            {["Streamline Patient Referrals", "Enhance Community Reach", "Secure Data Management"].map(
                                (item) => (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        {isSignIn ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <Field label="Hospital Name" name="name" placeholder="City General Hospital" value={formData.name} onChange={handleChange} />
                                <Field label="Registration No." name="registrationNumber" placeholder="REG-123456" value={formData.registrationNumber} onChange={handleChange} />
                                <Field label="Email Address" name="email" type="email" placeholder="contact@hospital.com" value={formData.email} onChange={handleChange} />
                                <Field label="Mobile / Phone" name="mobile" type="tel" placeholder="+1 (555) 000-0000" value={formData.mobile} onChange={handleChange} />

                                <div className="md:col-span-2">
                                    <Field label="Password" name="password" type="password" placeholder="••••••••" minLength={6} value={formData.password} onChange={handleChange} />
                                </div>

                                {/* Hospital Category */}
                                <div className="md:col-span-2">
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Hospital Category</label>
                                    <select
                                ...
                                <Field label="City" name="city" placeholder="Mumbai" value={formData.city} onChange={handleChange} />
                                <Field label="State / Province" name="state" placeholder="Maharashtra" value={formData.state} onChange={handleChange} />

                                <div>
                                    <Field label="Pincode / Zip Code" name="pincode" placeholder="400001" value={formData.pincode} onChange={handleChange} />
                                </div>
                            </div>
                        )}
